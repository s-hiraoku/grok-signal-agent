...
JSON
  ...
  assert_file_contains "${artifact_dir}/infographic.html" "入口 → 操作 → 結果"
  assert_file_contains "${artifact_dir}/infographic.html" "使い方の流れ"
...
JSON
  ...
  assert_file_contains "${artifact_dir}/infographic-01.html" "入口 → 操作 → 結果"
  assert_file_contains "${artifact_dir}/infographic-01.html" "使える場面"
  assert_file_contains "${artifact_dir}/infographic-01.html" "使い方の流れ"
