...
JSON
  ...
  assert_file_contains "${artifact_dir}/infographic.svg" "どういう機能か、どんな場面で使えるか"
  assert_file_contains "${artifact_dir}/infographic.svg" "次の確認フロー"
  assert_file_not_contains "${artifact_dir}/infographic.svg" "SOURCE LOCK"
  assert_file_not_contains "${artifact_dir}/infographic.svg" "公式ソース確認済み"
  assert_file_not_contains "${artifact_dir}/infographic.svg" "採用シグナル"
...
JSON
  ...
  assert_file_contains "${artifact_dir}/infographic-01.svg" "どういう機能？"
  assert_file_contains "${artifact_dir}/infographic-01.svg" "使える場面"
  assert_file_contains "${artifact_dir}/infographic-01.svg" "次の確認フロー"
  assert_file_not_contains "${artifact_dir}/infographic-01.svg" "採用シグナル"
  assert_file_not_contains "${artifact_dir}/infographic-01.svg" "公式ソース確認済み"
