...
JSON
  ...
  assert_file_contains "${artifact_dir}/infographic.svg" "入口 → 操作 → 結果"
  assert_file_contains "${artifact_dir}/infographic.svg" "使い方の流れ"
...
JSON
  ...
  assert_file_contains "${artifact_dir}/infographic-01.svg" "入口 → 操作 → 結果"
  assert_file_contains "${artifact_dir}/infographic-01.svg" "使える場面"
  assert_file_contains "${artifact_dir}/infographic-01.svg" "使い方の流れ"
